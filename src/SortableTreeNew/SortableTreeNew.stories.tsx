...
import { SortableTreeNew } from './index';
import { type TreeItem } from './types';

const meta: Meta<typeof SortableTreeNew> = {
  title: 'Data Display/SortableTreeNew',
  component: SortableTreeNew,
  parameters: {
    layout: 'fullscreen',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof SortableTreeNew>;

export default meta;

type Story = StoryObj<typeof SortableTreeNew>;
...
export const Default: Story = {
  render: (args) => {
    ...
    return (
      <Box h="100vh" w="100vw">
        <SortableTreeNew onChange={setTreeData} treeData={treeData} {...rest} />
      </Box>
    );
  },
};
